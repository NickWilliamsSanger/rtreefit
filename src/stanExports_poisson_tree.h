...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_poisson_tree");
    reader.add_event(152, 150, "end", "model_poisson_tree");
    return reader;
}
...
class model_poisson_tree : public prob_grad {
private:
        int N;
        int NINT;
        int NLAMBDA;
...
public:
    model_poisson_tree(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_poisson_tree_namespace::model_poisson_tree";
    ...
    void transform_inits(const stan::io::var_context& context__,
        ...
        pos__ = 0U;
        validate_non_negative_index("S", "N", N);
        context__.validate_dims("parameter initialization", "S", "vector_d", context__.to_vec(N));
        ...
        try {
            writer__.vector_lub_unconstrain(0.001, 0.999, S);
        } catch (const std::exception& e) {
        ...
        p = vals_r__[pos__++];
        try {
            writer__.scalar_lub_unconstrain(0.05, 0.999, p);
        } catch (const std::exception& e) {
    ...
    T__ log_prob(std::vector<T__>& params_r__,
        ...
        try {
            ...
            if (jacobian__)
                S = in__.vector_lub_constrain(0.001, 0.999, N, lp__);
            else
                S = in__.vector_lub_constrain(0.001, 0.999, N);
            current_statement_begin__ = 118;
            ...
            if (jacobian__)
                p = in__.scalar_lub_constrain(0.05, 0.999, lp__);
            else
                p = in__.scalar_lub_constrain(0.05, 0.999);
            current_statement_begin__ = 120;
            ...
            lp_accum__.add(beta_log<propto__>(S, 100, elt_divide(multiply(100, subtract(1, s)), s)));
            ...
            lp_accum__.add(poisson_log<propto__>(m, elt_multiply(elt_multiply(t, lambda_per_branch), S)));
            }
        } catch (const std::exception& e) {
            stan::lang::rethrow_located(e, current_statement_begin__, prog_reader__());
            // Next line prevents compiler griping about no return
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_poisson_tree_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
        ...
        Eigen::Matrix<double, Eigen::Dynamic, 1> S = in__.vector_lub_constrain(0.001, 0.999, N);
        size_t S_j_1_max__ = N;
        for (size_t j_1__ = 0; j_1__ < S_j_1_max__; ++j_1__) {
        ...
        double p = in__.scalar_lub_constrain(0.05, 0.999);
        vars__.push_back(p);
...
typedef model_poisson_tree_namespace::model_poisson_tree stan_model;
#endif
